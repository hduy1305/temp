...
SECRET_KEY = 'django-insecure-l^k(or2s&bo%&0za*g@(&ctcoi&*otnt8eduwiqu=*8uphjxb!'
...
# Nếu muốn giữ SQLite cho Django admin, nhưng không dùng Djongo nữa:
DATABASES = {
    'default': {
...
# Kết nối tới MongoDB
connect(
    db='appointment_db',       # tên database MongoDB
    host='localhost',
    port=27017,
